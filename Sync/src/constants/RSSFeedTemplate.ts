...
const feed_image =
  "https://mefobhismocgsttbgjwe.supabase.co/storage/v1/object/public/podcapsule-bucket/podcapsule-feed-image.png";
const feed_description =
  "Discover new episodes from your favorite podcasts, or rediscover old ones you may have missed. With Podcapsule, you can easily track podcasts you love and uncover hidden gems you might have otherwise overlooked!";

const episode_one_url =
  "https://mefobhismocgsttbgjwe.supabase.co/storage/v1/object/public/podcapsule-bucket/podcapsule-episode-one.mp3";
